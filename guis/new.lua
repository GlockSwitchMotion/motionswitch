...
local getcustomassets = {
	...
	['motionswitch/assets/new/guiv4.png'] = 'rbxassetid://105285248394660',
	['motionswitch/assets/new/guivape.png'] = 'rbxassetid://77835130675073',
	...
	['motionswitch/assets/new/textv4.png'] = 'rbxassetid://105285248394660',
	['motionswitch/assets/new/textvape.png'] = 'rbxassetid://77835130675073',
...
local function downloadFile(path, func)
	if not isfile(path) then
		...
		local suc, res = pcall(function()
			return game:HttpGet('https://raw.githubusercontent.com/MaxlaserTech/CatV6/'..readfile('motionswitch/profiles/commit.txt')..'/'..select(1, path:gsub('motionswitch/', '')), true)
		end)
