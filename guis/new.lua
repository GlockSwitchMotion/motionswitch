...
components = {
	...
	ColorSlider = function(optionsettings, children, api)
		...
		preview.Image = getcustomasset('motionrewrite/assets/new/colorpreview.png')
		...
		expand.Image = getcustomasset('motionrewrite/assets/new/expandicon.png')
		...
		rainbow1.Image = getcustomasset('motionrewrite/assets/new/rainbow_1.png')
		rainbow1.ImageColor3 = color.Light(uipallet.Main, 0.37)
		rainbow1.Parent = rainbow
		local rainbow2 = rainbow1:Clone()
		rainbow2.Image = getcustomasset('motionrewrite/assets/new/rainbow_2.png')
		rainbow2.Parent = rainbow
		local rainbow3 = rainbow1:Clone()
		rainbow3.Image = getcustomasset('motionrewrite/assets/new/rainbow_3.png')
		rainbow3.Parent = rainbow
		local rainbow4 = rainbow1:Clone()
		rainbow4.Image = getcustomasset('motionrewrite/assets/new/rainbow_4.png')
	...
	Dropdown = function(optionsettings, children, api)
		...
		arrow.Image = getcustomasset('motionrewrite/assets/new/expandright.png')
	...
	Targets = function(optionsettings, children, api)
		...
		icon.Image = getcustomasset('motionrewrite/assets/new/targetstab.png')
		icon.Parent = window
		local title = Instance.new('TextLabel')
		title.Name = 'Title'
		...
		optionapi.Players = components.TargetsButton({
			...
			Icon = getcustomasset('motionrewrite/assets/new/targetplayers1.png'),
			IconSize = UDim2.fromOffset(15, 16),
			IconParent = tool,
			ToolIcon = getcustomasset('motionrewrite/assets/new/targetplayers2.png'),
		...
		optionapi.NPCs = components.TargetsButton({
			...
			Icon = getcustomasset('motionrewrite/assets/new/targetnpc1.png'),
			IconSize = UDim2.fromOffset(12, 16),
			IconParent = tool,
			ToolIcon = getcustomasset('motionrewrite/assets/new/targetnpc2.png'),
	...
	TextList = function(optionsettings, children, api)
		...
		buttonicon.Image = optionsettings.Icon or getcustomasset('motionrewrite/assets/new/allowedicon.png')
		...
		icon.BackgroundTransparency = 1
		icon.Image = optionsettings.Tab or getcustomasset('motionrewrite/assets/new/allowedtab.png')
		icon.Parent = window
		local title = Instance.new('TextLabel')
		title.Name = 'Title'
		title.Size = UDim2.new(1, -36, 0, 20)
		...
		addbutton.Image = getcustomasset('motionrewrite/assets/new/add.png')
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				close.BackgroundTransparency = 1
				close.AutoButtonColor = false
				close.Image = getcustomasset('motionrewrite/assets/new/closemini.png')
				close.ImageColor3 = color.Light(uipallet.Text, 0.2)
				close.ImageTransparency = 0.5
				close.Parent = object
				addCorner(close, UDim.new(1, 0))
	...
	TwoSlider = function(optionsettings, children, api)
		...
		knob.Image = getcustomasset('motionrewrite/assets/new/range.png')
		...
		arrow.BackgroundTransparency = 1
		arrow.Image = getcustomasset('motionrewrite/assets/new/rangearrow.png')
